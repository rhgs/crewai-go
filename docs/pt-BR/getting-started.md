...
- [Memory](memory.md) — bag de curto prazo, `MemoryStore`, FileStore, embeddings, tools opt-in `recall_memory` / `remember`.
...
- [Training / traces](training.md) — export JSONL com `TraceRecorder`.
